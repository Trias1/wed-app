        ...
        <section id='invitation'>
            ...
            <div className="container">
                    <div className="about__me-image">
                        <img className="kali-graf" height ={50} width ={100} src={bismillah}></img>
                        <h4>Assalamu`alaikum Warahmatullaahi Wabarakaatuh</h4>
                        <h5>Dengan memohon rahmat Allah S.W.T kami bermaksud menyelenggarakan pernikahan putra-putri kami:</h5>
                        <h5></h5>
                    </div>
                </div>
